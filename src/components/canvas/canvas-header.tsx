...
import ShareDialog from '../canvas-url-sharing/share-dialog';
import ActiveUsers from '../canvas-url-sharing/active-users';
        ...
        <div className="flex items-center space-x-4">
          ...
          {isEditing ? (
            ...
            <button
              ...
              className={`text-lg font-medium text-gray-900 px-2 py-1 rounded transition-colors ${
          ...
          {/* View-only badge */}
          {!canEdit && <span className="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-600 rounded">View Only</span>}
        </div>
